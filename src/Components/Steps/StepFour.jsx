    ...
    <div className={styles.stepsBlock}>
      ...
      <div className="mb-60">
        <div className={styles.formControl}>
          <input type="radio" id="penetration" defaultChecked name="radio" value="second"></input>
          <label htmlFor="penetration">Market Penetration</label>
        </div>

        <div className={styles.formControl}>
          <input type="radio" id="development" disabled={true} name="radio" value="first"></input>
          <label htmlFor="development">Market Development</label>
        </div>


        <div className={styles.formControl}>
          <input type="radio" id="product" disabled={true} name="radio" value="Third"></input>
          <label htmlFor="product">Product Development</label>
        </div>

        <div className={styles.formControl}>
          <input type="radio" id="diversification" disabled={true} name="radio" value="fouth"></input>
